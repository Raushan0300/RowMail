...
const Compose = (props: any) => {
  ...
  const handleFileChange = (e: any) => {
    ...
    if (files) {
      ...
      const newMimeTypes = newFiles.map((file) => file.type);
      ...
      setMimeTypes((prev) => [...prev, ...newMimeTypes]); // Append new mime types to existing mime types
    }
  };
        ...
        <div className="flex flex-col h-full">
          <div className="flex justify-between gap-5 items-center px-5 border-b pb-1.5">
            ...
            <div className="flex gap-3 items-center">
              ...
              {!isSending ? (
                <button
                  className="text-[12px] font-bold text-white bg-[#4834F6] px-4 py-1.5 rounded-lg hover:bg-[#3479BD]"
                  onClick={() => {
                    sendEmail();
                  }}>
                  Send
          ...
          <div
            ...
            <FilePreviewer
              ...
              onClose={() => {
                ...
                setMimeTypes((prev) => prev.filter((_, i) => i !== index));
              }}
            />
          </div>
        ))}
